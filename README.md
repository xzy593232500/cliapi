...
## Quota / Redeem Code Extension

This working tree is being extended with a token quota system on top of the original CLIProxyAPI runtime.

Current extension direction:

- keep original routing / inference core intact
- add token balance accounts per client API key
- fixed exchange rate: `1 USD = 500000 tokens`
- consume quota by actual token usage
...
- `CPA_QUOTA_POSTGRES_DSN`
- fallback: `DATABASE_URL`

Current management endpoints added in this tree:

- `GET /v0/management/quota/accounts`
- `GET /v0/management/quota/transactions`
- `GET /v0/management/quota/redeem-codes`
- `POST /v0/management/quota/redeem-codes`
- `POST /v0/management/quota/adjust`
- `POST /v0/management/quota/redeem`

Current user endpoints added in this tree:
