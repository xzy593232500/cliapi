...
func NewServer(cfg *config.Config, authManager *auth.Manager, accessManager *sdkaccess.Manager, configFilePath string, opts ...ServerOption) *Server {
	...
	s.mgmt.SetQuotaStore(quota.DefaultStore())
...
func (s *Server) setupRoutes() {
	...
	s.engine.GET("/management-quota.html", s.serveQuotaControlPanel)
	...
	v1.Use(AuthMiddleware(s.accessManager), middleware.QuotaBalanceMiddleware())
	{
...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/quota/accounts", s.mgmt.GetQuotaAccounts)
		mgmt.GET("/quota/transactions", s.mgmt.GetQuotaTransactions)
		mgmt.GET("/quota/redeem-codes", s.mgmt.GetRedeemCodes)
		mgmt.POST("/quota/redeem-codes", s.mgmt.PostRedeemCodes)
		mgmt.POST("/quota/adjust", s.mgmt.PostQuotaAdjust)
		mgmt.POST("/quota/redeem", s.mgmt.PostQuotaRedeem)
...
func (s *Server) serveManagementControlPanel(c *gin.Context) {
	...
	c.Data(http.StatusOK, "text/html; charset=utf-8", injectManagementQuotaPanel(content))
}
